...
namespace com.clusterrr.Famicom.CoolGirl
{
    internal class Config
    {
        ...
        public string Ca65 { get; private set; } = "ca65";
        public string Ld65 { get; private set; } = "ld65";
        public string Ca65Args { get; private set; } = "";
        public string Ld65Args { get; private set; } = "";
        public string SourcesDir { get; private set; } = ".";
        public string? GamesFile { get; private set; } = null;
        public string? AsmFile { get; private set; } = "games.inc";
        ...
        public static void PrintHelp()
        {
            ...
            Console.WriteLine("  {0,-20}{1}", "--asm", "- output file for the loader, default is \"games.inc\"");
            ...
            Console.WriteLine($" {exename} build --games <games.txt> [--asm <games.inc>] [--nesasm <nesasm>] [--nesasm-args <args>] [--sources <path>] [--nosort] [--report <report.txt>] [--maxromsize <size_mb>] [--maxchrsize <size_kb>] [--language <language>] [--badsectors <sector,sector,...>] [--mappers <coolgirl-mappers.json>] [--fixes <nes-fixes.json>] [--symbols <coolgirl-symbols.json>] [--unif <multirom.unf>] [--nes20 <multirom.nes>] [--bin <multirom.bin>]");
            Console.WriteLine("  {0,-20}{1}", "--games", "- input plain text file with list of ROM files");
            Console.WriteLine("  {0,-20}{1}", "--asm", "- temporary file for the loader, default is \"games.inc\"");
            Console.WriteLine("  {0,-20}{1}", "--ca65", "- path to the ca65 compiler executable");
            Console.WriteLine("  {0,-20}{1}", "--ca65-args", "- additional command-line arguments for ca65");
            Console.WriteLine("  {0,-20}{1}", "--ld65", "- path to the ld65 linking executable");
            Console.WriteLine("  {0,-20}{1}", "--ld65-args", "- additional command-line arguments for ld65");
